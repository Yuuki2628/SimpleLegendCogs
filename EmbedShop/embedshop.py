...
#Rare: 815957842266816522
    ...
    async def es_shop(self, ctx):
        ...
        embed.add_field(name="**Items prices**", value="```\n"
            "Item name                   Price  Elite price  Command/Requirement\n"
            "Emoji flair:              200,000            ~  ~                  \n"
            "Custom background:        800,000            ~  ~                  \n"
            "Custom command:           500,000            ~  ~                  \n"
            "Rare:                   1,500,000            ~  cmd: !buyrare      \n"
            "Epic:                   3,500,000            ~  cmd: !buyepic      \n"
            "Legendary:             10,000,000            ~  cmd: !buylegendary \n"
            "Elite:                 35,000,000            ~  cmd: !buyelite     \n"
            "Custom adventure boss: 10,000,000    5,000,000  req: LeGeNDary     \n"
            "x10 set loot chests:    5,000,000    2,500,000  req: LeGeNDary     \n"
            "Simple embed update:    5,000,000    2,500,000  req: LeGeNDary     \n"
            "Elite embed update:    15,000,000   15,000,000  req: Elite         \n"
            "```", inline=False)
