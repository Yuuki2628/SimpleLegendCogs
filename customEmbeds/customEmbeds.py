...
├───────────────────────────┤
│     [1;30mAbility: [30mFlame body   [0;37m│
├─────────────╥─────────────┤
...
└─────────────╨─────────────┘```""", inline=True)
        embed.add_field(name="", value="""```ansi
[37m┌───────────────────────────┐
│        [1;35mZygarde(10%)       [0;37m│
├───────────────────────────┤
│  [1;30mAbility: [30mPower Construct [0;37m│
├─────────────╥─────────────┤
...
│           [1;35mLugia           [0;37m│
├───────────────────────────┤
│     [1;30mAbility: [30mMulticale    [0;37m│
├─────────────╥─────────────┤
...
│         [1;35mReshiram          [0;37m│
├───────────────────────────┤
│     [1;30mAbility: [30mTurboblaze   [0;37m│
├─────────────╥─────────────┤
...
╞═════════════╬═════════════╡
│[0;32mExtreme Speed[1m║  [0;32mEarthquake [1m│
└─────────────╨─────────────┘```""", inline=True)
        embed.add_field(name="", value="""```ansi
[37m┌───────────────────────────┐
